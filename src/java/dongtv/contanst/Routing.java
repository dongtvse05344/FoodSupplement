...
public class Routing {
    ...
    public static String INVALID_VIEW = "view/error.jsp";
    ...
    public static String CRAWL_ADMIN_VIEW = "view/admin/crawl.jsp";
    public static String EDIT_PRODUCT_ADMIN_VIEW = "view/admin/editProduct.jsp";
